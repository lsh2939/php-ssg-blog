...
<!-- svgs 시작 -->
<div class="svgs">
    <svg id="acatar-1" viewBox="0 0 264 280" version="1.1" xmlns="http://www.w3.org/2000/svg"
                    ...
                    <g id="Avataaar" stroke-width="1" fill-rule="evenodd" mask="url(#mask-4)">
                        ...
                        <g id="Clothing/Hoodie" transform="translate(0.000000, 170.000000)">
                            ...
                            <path
                                ...
                                id="Straps" fill="#F4F4F4" fill-rule="evenodd" mask="url(#react-mask-176)"></path>
                            <path
                        ...
                        <g id="Face" transform="translate(76.000000, 82.000000)" fill="#000000">
                            <g id="Mouth/Smile" transform="translate(2.000000, 52.000000)">
                                ...
                                <use id="Mouth" fill-opacity="0.699999988" fill="#000000" fill-rule="evenodd"
                                    xlink:href="#react-path-195"></use>
                                <rect id="Teeth" fill="#FFFFFF" fill-rule="evenodd" mask="url(#react-mask-196)" x="39"
                                    y="2" width="31" height="16" rx="5"></rect>
                                <g id="Tongue" stroke-width="1" fill-rule="evenodd" mask="url(#react-mask-196)"
                                    fill="#FF4F6D">
                        ...
                        <g id="Top" stroke-width="1" fill-rule="evenodd">
                            <defs>
                                ...
                                <path
                                    ...
                                    id="react-path-135"></path>
                                <filter x="-0.8%" y="-2.0%" width="101.5%" height="108.0%"
                                    filterUnits="objectBoundingBox" id="react-filter-132">
                                    ...
                                    <g id="Top/_Resources/Round" fill="none"
                                        ...
                                        <defs>
                                            <path
                                                ...
                                                id="react-path-149"></path>
                                            <filter x="-0.8%" y="-2.1%" width="101.6%" height="108.3%"
                                                filterUnits="objectBoundingBox" id="react-filter-150">
                                        ...
                                        <g id="Lennon-Glasses">
                                            <use fill="black" fill-opacity="1" filter="url(#react-filter-150)"
                                                xlink:href="#react-path-149"></use>
